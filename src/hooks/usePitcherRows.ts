        ...
        if (data) {
            if (activeDivision === "d1") {
                setFilteredData(data.data
                    ...
                    .filter((elem: PitcherInterface) => filters.bbRate[1] >= Number(elem.bbRate) && filters.bbRate[0] <= Number(elem.bbRate))
                    .filter((elem: PitcherInterface) => filters.hRate[1] >= Number(elem.hRate) && filters.hRate[0] <= Number(elem.hRate))
                    .filter((elem: PitcherInterface) => filters.kRate[1] >= Number(elem.kRate) && filters.kRate[0] <= Number(elem.kRate))
                    .filter((elem: PitcherInterface) => filters.soTObb[1] >= Number(elem.soTObb) && filters.soTObb[0] <= Number(elem.soTObb))
                    // Filter by Search
